...
const Header = ({
  ...
  return (
    <div className='relative w-full p-8 items-center  pr-8 flex justify-between text-dark-200 font-bold dark:text-white lg:py-12 lg:justify-around'>
      ...
      <button onClick={onOpenSideBarMobile}>
        <Bars3Icon className='h-7 text-dark-200 md:h-10 lg:hidden dark:text-white'/>
      </button>
